...
# ╔═╡ ea7f5912-74a9-4466-a2ef-3be0059b817f
begin
...
# ╔═╡ 98fdbd1b-d909-499f-ab25-fe4f08c2fd42
using PlutoUI; PlutoUI.TableOfContents(include_definitions=false)

# ╔═╡ cb8b4fc0-9774-11ef-0d41-6d4dd5720ca4
html"""
...
# ╔═╡ 8ac49713-5c0f-4bad-8ff3-8a486dee1f9b
md"""
...
# ╔═╡ 9e4ba49a-03f3-4024-af54-f294055683e9
md"""
First, we import some packages that we will be needing along the way
"""

# ╔═╡ f1f89900-9af6-4fbc-9bd5-6345498f9688
md"""
# Simple Kuramoto Model
"""

# ╔═╡ fe3f8f24-0bdb-4cb4-a764-8df9e2062a71
md"""
...
# ╔═╡ c0781404-3279-49cb-8fe9-daf0304a2f81
...
# ╔═╡ 0b993437-a7d5-4f04-b823-c95af5550b59
...
# ╔═╡ 57e689e6-3817-4dd9-aa10-1f63058bb1b1
...
# ╔═╡ 6e916a3b-8b84-4784-a97d-f98c93114711
md"""
## Visual representation of phase locking
"""

# ╔═╡ eeca8b2d-ee3b-4032-9412-d1b620c6ec75
begin
	N = 10
	K = 5
	ω = randn(N) * 2
...
# ╔═╡ 5f09b26f-0f04-4ac3-868c-4564d5cf8999
md"""
...
# ╔═╡ 9b9f07cb-6025-4506-b706-a34a3eef1ee7
# ╠═╡ show_logs = false
PlotOscillators(kuramoto_sol, "./outputs/phase_locking.gif")

# ╔═╡ 50c838e1-7f79-4d2a-8f31-66b9256f8ac8
md"""
## Evolution of `r`
"""

# ╔═╡ 55246b34-49c5-4096-901f-73b921f0eefb
md"""
...
# ╔═╡ 4058c7c3-93de-455c-9b68-a4b802b33357
begin
	evR_N = 20000
...
# ╔═╡ c15548e8-fdb9-4401-a21e-09b291496901
md"""
## Threshold `K`
"""

# ╔═╡ 1c3ebd8e-ca63-44d2-9fd0-8944aefc2819
begin
...
# ╔═╡ 82ac5f4b-b38c-4bb8-af14-54f110b981da
function NNKuramotoPlot(sol, fname)
...
# ╔═╡ 2cd00f5b-3e88-4d22-8392-f156933a4412
begin
...
# ╔═╡ 4c6b1ab7-b0d3-401b-9132-6ded8a1c9b17
...
# ╔═╡ ae5fcc1d-0a6f-42ca-a427-d2a69d6661bc
# ╠═╡ show_logs = false
NNKuramotoPlot(NNSolKuramoto(neighbors_moore, NN_K, NN_ω, NN_θ₀, NN_t, NN_step_size), "./outputs/kuramoto_lattice.gif")

# ╔═╡ 62ce0345-8e30-4241-9c73-a886fe459dd9
md"""
## With phase offset
"""

# ╔═╡ 1defe278-d91d-43c4-9c10-2f637b6452cc
md"""
Now we introduce an offset of π/4.
"""

# ╔═╡ 6d4af142-b8d4-4668-add6-cbc3cc1ef2bf
begin
	NN_offset_N = 100
	NN_offset_dims = (NN_N, NN_N)
	NN_offset_K = 300
	NN_offset_ω = randn(NN_dims) * 2
	NN_offset_θ₀ = rand(Float64, NN_dims) * 2π
	NN_offset_t = 0.5
	NN_offset_step_size = 0.002
	offset = π/6
	NN_offset_ϕ = fill(offset, NN_dims)
end;

# ╔═╡ 185e349d-dfa6-4cd5-ba5a-28fa62ace108
# ╠═╡ show_logs = false
NNKuramotoPlot(NNSolKuramoto(neighbors_moore, NN_offset_K, NN_offset_ω, NN_offset_θ₀, NN_offset_t, NN_offset_step_size, NN_offset_ϕ), "./outputs/kuramoto_lattice_offset.gif")

# ╔═╡ 17576978-f766-43bc-8ac4-839bc0b28057
md"""
# References
...
manifest_format = "2.0"
project_hash = "35284d65b00028fca109c80b64cc9c3262e7ae0b"
