...
#let ilm(
  ...
  table-of-contents: none, //outline(title: "Contents"),
  ...
  set document(title: title, author: group-no)
  ...
  show raw: set text(font: ("Maple Mono"), size: 9pt)
  ...
  page(align(center + horizon, block(width: 90%)[
      ...
      #par(justify: true, text(size: 2.5em)[*#title*])
      ...
      #grid(
        // columns: (1fr, 1fr, 1fr),
        // grid(rows: 2, row-gutter: 1em, align: center,
          // text(size: 1.25em, "Hena"), text(size: 1.25em, "MS21093")),
        grid(rows: 2, row-gutter: 1em, align: center,
          text(size: 1.25em, "Rishi Vora"), text(size: 1.25em, "MS21113")),
        // grid(rows: 2, row-gutter: 1em, align: center,
          // text(size: 1.25em, "Sparsha Ray"), text(size: 1.25em, "MS21256")),
      )
      ...
      // #grid(
        // columns: (1fr, 1fr, 1fr),
        // grid.cell(align: left, "Group 11"),
        // [],
        // grid.cell(align: right, text(date.display(date-format))),
      // )
  ...
  set page(
    ...
    //   let aln = center // if is-odd { right } else { left }
